...
try {
    ...
    // Consultar productos que estén validados
                ...
                <div class="col-md-4">
                    <div class="card h-100">
                        <div id="carousel-<?php echo $producto['id']; ?>" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                <?php 
                                $imagenes = [$producto['imagen'], $producto['imagen2'], $producto['imagen3'], $producto['imagen4'], $producto['imagen5']];
                                foreach ($imagenes as $index => $ruta_imagen): 
                                    if (!empty($ruta_imagen)): ?>
                                        <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>">
                                            <img src="<?php echo htmlspecialchars($ruta_imagen); ?>" class="d-block w-100">
                                        </div>
                                    <?php endif; 
                                endforeach; ?>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <a href="verProducto.php?id=<?php echo $producto['id']; ?>" class="btn btn-warning">Ver producto</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-center">
            <a class="navbar-brand" href="#">
                <img src="../../img/4-removebg-preview (1).png" alt="Logo" class="d-block" style="width: 100px; height: 50px;">
            </a>
        </div>
    </div>
</footer>
